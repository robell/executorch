...
# Optional VGF enable for the default pybind/install flow.
# This is intentionally scoped to this preset rather than acting as a general
# environment-to-CMake override mechanism.
...
if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
  ...
  set_overridable_option(EXECUTORCH_BUILD_VULKAN
                         ${_executorch_pybind_enable_vgf}
  )
  set_overridable_option(EXECUTORCH_BUILD_VGF
                         ${_executorch_pybind_enable_vgf}
  )
